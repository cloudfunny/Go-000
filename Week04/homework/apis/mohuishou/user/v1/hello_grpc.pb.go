...
func (c *userServerClient) GetUserInfo(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*GetUserInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mohuishou.user.v1.UserServer/GetUserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserServer_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mohuishou.user.v1.UserServer/GetUserInfo",
	}
...
var _UserServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mohuishou.user.v1.UserServer",
	...
	Metadata: "apis/mohuishou/user/v1/hello.proto",
}
